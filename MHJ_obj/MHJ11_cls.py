""" Метод Хука-Дживса с использованием суммы успешных направлений.
    Корень методов, улучшающих базовый метод, но без использования ОУДС,
"""
